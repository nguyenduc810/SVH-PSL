    ...
    def train(self, pop_dec, labels, samples_pool):
        ...
        for epoch in range(self.epoches):
            ...
            # train the D with fake data
                ...
                dd = d_train_loss.cpu().data.numpy()
                ...
                gg = g_train_loss.cpu().data.numpy()
        ...
        # dr.append(dd)
        # gr.append(gg)
        # df = pd.DataFrame(dr, columns=['Column1'])
        # df.to_excel('d.xlsx', index=False)
        # df = pd.DataFrame(gr, columns=['Column1'])
        # df.to_excel('g.xlsx', index=False)
        # print(1)
